...
public class MainActivity extends AppCompatActivity implements MasterListFragment.OnImageClickListener{
    ...
    public static final String HEAD_INDEX_KEY = "headkey";
    public static final String BODY_INDEX_KEY = "bodykey";
    public static final String LEG_INDEX_KEY = "legkey";
    ...
    public void onImageSelected(int position) {
        ...
        args.putInt(HEAD_INDEX_KEY, headIndex);
        args.putInt(BODY_INDEX_KEY, bodyIndex);
        args.putInt(LEG_INDEX_KEY, legIndex);
